...
The University of Grenoble offers, thanks to the High Performance Computing (HPC) centre \emph{Ciment}, this kind of environement with the data management system \emph{Irods}
...
With the Whisper project, as with some few other projects, we had the opporunity to test and improve the CIMENT IT infrastructure for a data-intensive case. 
