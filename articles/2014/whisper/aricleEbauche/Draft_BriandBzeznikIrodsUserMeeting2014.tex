...
\begin{center}%[h]
\centering
\captionof{figure}{\label{schemaCigriArch} Cigri communications}
\includegraphics[width=8cm]{cigri_arch.png}
\end{center}
...
\begin{center}%[h]
\centering
\captionof{figure}{\label{schemaCigriJDL} Cigri jobs campaign submission}
\includegraphics[width=8cm]{cigri_sub.png}
\end{center}
