...
iRODS works with a meta-catalogue server (iCat) and several servers connected to storage resources.


The iRODS storage infrastructure of Ciment consists of a unique zone with the iCat server and several nodes, of the order of several tens,
