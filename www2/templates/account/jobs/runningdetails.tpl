...
<tr><td align="center">
	{if $nbitems neq 0}
		...
		<tr>
			...
			<td>&nbsp;-&nbsp;</td>
			{if $nbexecuted > 0}<td><a href="account.php?submenu=jobs&option=executedparams&id={$jobid}">Executed Parameters</a>{else}<td style="font-style: italic;">Executed Parameters{/if}</td>
			<td>&nbsp;-&nbsp;</td>
